...
const sendVerifyMail = async(name, email, user_id)=>{
    ...
    try {
        ...
        const mailOptions = {
            ...
            html:'<p>Hii '+name+', please click here to <a href="https://admin-user-controll-system-ajay.onrender.com/verify?id='+user_id+'"> Verify </a> your mail.</p>'
        }
...
const sendResetPasswordMail = async(name, email, token)=>{
    ...
    try {
        ...
        const mailOptions = {
            ...
            html:'<p>Hii '+name+', please click here to <a href="https://admin-user-controll-system-ajay.onrender.com/forget-password?token='+token+'"> Reset </a> your password.</p>'
        }
        transporter.sendMail(mailOptions, function(error,info){
            if(error){
                console.log(error);
